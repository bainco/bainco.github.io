...
# and of any color
def draw_square_2(side_length, color):
...
draw_square_2(100, "red")

turtle_2.forward(100)

# An even more flexible function that can draw a sqaure of any size
# and of any color
def draw_square_3(side_length, color="green"):
    turtle_2.pencolor(color)
    turtle_2.forward(side_length)
    turtle_2.right(90)
    turtle_2.forward(side_length)
...
def draw_square_4(the_turtle, side_length, color="green"):
...
draw_square_4(turtle_3, 100, color="red")
draw_square_4(turtle_1, 400, color="purple")
