...
people = [
    ...
    ['Amy Meyer', '5558 Brown Street Apt. 718', 'Calebport', 'Wyoming', '54479', 'Administrator, charities/voluntary organisations'],
    ['Michael Gutierrez', '560 Rhonda Isle Apt. 851', 'West Dakotaside', 'South Carolina', '54479', 'Location manager'],
    ['Victoria Zhang', '9007 Rivera Highway Apt. 726', 'Andreafurt', 'Connecticut', '54479', 'Lecturer, further education'],
    ['Dorothy Acevedo', '43878 Deleon Ranch Apt. 191', 'Emilystad', 'Vermont', '54479', 'Social worker'],
    ['Richard Haley', '482 Robertson Plaza', 'West Kelly', 'Alabama', '54479', 'Fashion designer'],
...
### Exercise 4a
print("***** Exercise 4a *****")
def get_list_of_unique_zip_codes(list_of_people:list):
    list_to_return = [] # Make an empty list to store zip codes in
    for person in list_of_people: # for each person in our list
        if person[4] not in list_to_return:
            list_to_return.append(person[4]) # add their zip code to the list to return

    return list_to_return # and finally return the list so it can be used by other stuff

# Now actually invoke (call) the function with our list of people
print(get_list_of_unique_zip_codes(people))
