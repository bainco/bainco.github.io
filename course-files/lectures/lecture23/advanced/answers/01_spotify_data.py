...
def search_for_tracks(search_term: str):
    ...
    ## TODO - Fill in the parameter names and values for the Spotify API on APITutor
...
the_mp3_url = track_list[user_input]['preview_url']
mp3_file_name = track_list[user_input]['name'] + ".mp3"
write_url_to_file(the_mp3_url, mp3_file_name)

## TODO - Ask the user to pick a track from the ones you printed out and allow
## them to download an jpg of the album cover
user_input = input('Which track do you want the album cover for (enter a #)? ')
...
the_jpg_url = track_list[user_input]['album']['image_url']
jpg_file_name = track_list[user_input]['album']['name'] + ".jpg"
write_url_to_file(the_jpg_url, jpg_file_name)
