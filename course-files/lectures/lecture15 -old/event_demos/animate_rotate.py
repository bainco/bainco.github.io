...
def make_creature(canvas, center, size=100, my_tag='creature', my_fill='hotpink'):
    ...
    utilities.make_poly_circle(canvas, center, size, color=my_fill, tag=my_tag)
    utilities.make_poly_oval(canvas, left_eye_pos, eye_width, eye_height, color='black', tag=my_tag)
    utilities.make_poly_oval(canvas, right_eye_pos, eye_width, eye_height, color='black', tag=my_tag)
